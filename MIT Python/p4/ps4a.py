    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print('"' + word +'" earned ' + str(thisScore) + 'points. Total: ' + str(score) + ' points')
                print()
                # Update the hand 
...
def playGame(wordList):
    ...
    while True:
       try:
           ...
           if not (command == 'e' or command == 'r' or command == 'n'):
