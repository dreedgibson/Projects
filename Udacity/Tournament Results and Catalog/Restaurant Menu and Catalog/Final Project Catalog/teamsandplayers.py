...
# Create dummy user
User1 = User(name="Robo Sportscaster", email="tinnyTim@udacity.com",
             picture='https://pbs.twimg.com/profile_images/2671170543/18debd694829ed78203a5a36dd364160_400x400.png')
session.add(User1)
session.commit()

# Batters for Rangers
team1 = Team(user_id=1, name="Texas Rangers", logo='http://content.sportslogos.net/logos/53/77/full/ajfeh4oqeealq37er15r3673h.png')
team2 = Team(user_id=1, name="Colorado Rockies", logo='http://content.sportslogos.net/logos/54/58/full/ej4v6a8q5w5gegtf7ilqbhoz7.png')
session.add(team1)
session.commit()
session.add(team2)
session.commit()

batter1 = Batter(user_id=1, name="Adrian Beltre", HR=35, SB=15, pos="3B",
                     batting_average=".333", team=team1)

session.add(batter1)
session.commit()

batter1 = Batter(user_id=1, name="Nolan Arenao", HR=45, SB=15, pos="3B",
                     batting_average=".333", team=team2)
